...
exports.getNarcClaimConfirmation = void 0;
const ethers_1 = require("ethers");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config({ path: "../.env" });
const getProviderUrl_1 = require("./getProviderUrl");
const nftFaucet_1 = require("../artifacts/nftFaucet");
const getNarcClaimConfirmation = (chain, userAddress) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const claimed = yield contract.narcClaimedBy(userAddress);
        return claimed;
    }
    catch (error) {
...
exports.getNarcClaimConfirmation = getNarcClaimConfirmation;
