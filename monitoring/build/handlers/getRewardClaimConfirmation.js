...
exports.getLastRewardClaimEvent = void 0;
const ethers_1 = require("ethers");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config({ path: "../.env" });
const eventAbi_1 = require("../artifacts/eventAbi");
const getProviderUrl_1 = require("./getProviderUrl");
const getLastRewardClaimEvent = (chain, startBlock, userAddress) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getLastRewardClaimEvent = getLastRewardClaimEvent;
