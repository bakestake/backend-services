...
exports.getLastStakeEvent = void 0;
const ethers_1 = require("ethers");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config({ path: "../.env" });
const eventAbi_1 = require("../artifacts/eventAbi");
const getProviderUrl_1 = require("./getProviderUrl");
const getLastStakeEvent = (chain, startBlock, userAddress) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        data2 = yield contract.queryFilter(filter, Number(startBlock), parseInt(startBlock) + 50);
...
exports.getLastStakeEvent = getLastStakeEvent;
