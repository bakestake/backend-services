...
const BeraStateUpdate = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const setterInst = new ethers_1.ethers.Contract("0x26705ad938791e61aa64a2a9d808378805aec819", setter_1.ABI, new ethers_1.ethers.Wallet(process.env.STATE_PRIVATE_KEY || "", new ethers_1.ethers.JsonRpcProvider((0, getProviderUrl_1.getProviderURLs)("beraTestnet") || "")));
        console.log("doing tx");
        const tx = yield setterInst.setGlobalBudsState(globalBudsCount);
        yield tx.wait();
    }
    catch (error) {
        console.log(error);
